...
% XXX what happens if we run out of randomness?
...
% that
% XXX emphasize that the Enron set is just one example
% - emphasize that the Enron set is just one example, only used to get a very 
% rough estimate
...
% XXX describe protocol in more detail, still rely on OTR?
...
\marginpar{\raggedright
  Both this section and this figure are far from done \dots
}
...
\begin{figure}
  ...
  \begin{sequencediagram}
    ...
    \begin{sdblock}{Private channel}{}
      \mess{A}{Random data}{B}
    \end{sdblock}
    \begin{sdblock}{Public channel}{}
      \mess{A}{Ciphertext and MAC}{E}
      \mess{E}{Ciphertext and MAC}{B}
      \mess{B}{Ciphertext and MAC}{E}
      \mess{E}{Ciphertext and MAC}{A}
    \end{sdblock}
...
\marginpar{\raggedright
  ...
  This is also the reason why they are rounded to have no decimals, rather than 
  rounded according to their number of significant digits.
}
...
% XXX how secure is Android's SecureRandom?  enough entropy?
